...
def video_classify_metric(
    ...
    assert n_way > top_k
    processor = VideoMAEImageProcessor.from_pretrained('/data0/home/Datastation/Pretrained_Models/VideoMAE',
                                                       cache_dir=cache_dir)
    model = VideoMAEForVideoClassification.from_pretrained('/data0/home/Datastation/Pretrained_Models/VideoMAE',
