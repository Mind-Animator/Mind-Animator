...
if __name__ == "__main__":
  ...
  parser.add_argument('--Train_text_condition_save_path', type=str, default=None)
  parser.add_argument('--Test_captions_save_path', type=str, default=None)
  parser.add_argument('--Test_text_condition_save_path', type=str, default=None)
  ...
  np.save(args.Train_text_condition_save_path + '/Train_embeddings_new.npy', Train_)
  ...
  np.save(args.Test_text_condition_save_path + '/Test_embeddings_new.npy', Test_)
